      ...
      const [
        ...
        { data: shortcutRowsRaw, error: shortcutErr },
          ...
          service
            ...
            .select(
              'user_id, slot, origin_lat, origin_lng, destination_lat, destination_lng, origin_label, destination_label, scheduled_date, scheduled_time, scheduled_arrival_time, schedule_daily, schedule_weekday_mask, updated_at'
            )
            .eq('enabled', true)
