-- Permitir que cualquier usuario autenticado vea el detalle de un viaje publicado
-- (para que pasajeros puedan abrir el detalle y reservar paradas; antes solo conductor/admin/pasajero con reserva).
...
BEGIN
  ...
  -- (d) viaje publicado: cualquier usuario autenticado puede ver el detalle para reservar
...
COMMENT ON FUNCTION public.get_ride_detail_for_user(uuid) IS 'Detalle de un ride para conductor, admin, pasajero con reserva o cualquier usuario si status=published (para reservar).';
