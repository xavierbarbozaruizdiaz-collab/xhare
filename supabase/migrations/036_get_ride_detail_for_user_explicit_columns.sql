-- Devolver solo columnas usadas por /rides/[id]; evitar to_jsonb(v_ride) que expone todo el row.
...
COMMENT ON FUNCTION public.get_ride_detail_for_user(uuid) IS 'Detalle de un ride para conductor, admin o pasajero con reserva activa. Devuelve solo columnas usadas por /rides/[id].';
