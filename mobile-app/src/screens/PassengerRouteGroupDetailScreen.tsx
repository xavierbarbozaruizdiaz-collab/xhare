...
type Nav = NativeStackNavigationProp<MainStackParamList, 'PassengerRouteGroupDetail'>;
type Route = RouteProp<MainStackParamList, 'PassengerRouteGroupDetail'>;
...
export function PassengerRouteGroupDetailScreen() {
  ...
  return (
    <ScrollView style={styles.container} contentContainerStyle={styles.content}>
      ...
      >
        <Text style={styles.primaryBtnText}>Unirme a esta ruta</Text>
      </TouchableOpacity>
    </ScrollView>
  );
}
