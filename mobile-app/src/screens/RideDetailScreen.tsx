...
type Route = RouteProp<MainStackParamList, 'RideDetail'>;

/**
 * Implementación mínima para que la app no crashee al abrir un detalle.
 * La vista completa del detalle (mapa + paradas) se integra luego.
 */
