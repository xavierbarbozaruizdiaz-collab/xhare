...
export function MyPublishedRidesScreen() {
  ...
  const bucketLabels: Record<Bucket, { title: string; subtitle: string }> = {
    programados: {
      title: 'Programados',
      subtitle: 'Próximas salidas o en curso (dentro del horario estimado).',
    },
    noRealizados: {
      title: 'No realizados',
    ...
    <View style={styles.container}>
      ...
      {!hasAnyRide ? (
        <View style={styles.empty}>
          ...
          <TouchableOpacity style={styles.linkBtn} onPress={() => parentNav?.navigate('PublishRide', {})}>
        ...
        <>
          ...
          {openBucket == null ? (
            ...
            <FlatList
              ...
              renderItem={({ item }) => (
                <RideCard r={item} onPress={() => parentNav?.navigate('RideDetail', { rideId: item.id })} />
              )}
            />
          )}
        </>
