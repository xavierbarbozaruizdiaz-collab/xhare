/**
 * Reglas conductor ↔ viaje (móvil). Espejo de `src/lib/driver-ride-rules.ts` en Next.
 */
...
export function occupiedSeatsFromRide(
...
export function checkDriverAccountAllowsOperation(
  account: DriverAccountGate | null | undefined,
  nowMs: number = Date.now()
): RuleResult {
